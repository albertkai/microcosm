...
Roles._uiHelpers = {                                                                                               // 21
   ...
   *                                                                                                               // 36
   * @method isInRole                                                                                              // 37
   * @param {String} role Name of role or comma-seperated list of roles                                            // 38
   * @param {String} [group] Optional, name of group to check                                                      // 39
   * @return {Boolean} true if current user is in at least one of the target roles                                 // 40
   * @static                                                                                                       // 41
   * @for UIHelpers                                                                                                // 42
   */                                                                                                              // 43
...
//# sourceMappingURL=c84748e07c53cb4f7634ef9cbb77e19852f3c262.map
